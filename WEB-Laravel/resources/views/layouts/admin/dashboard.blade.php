...
<head>
    ...
    <script src="admin_resources/assets/js/vendor/visualization/d3/d3.min.js"></script>
	<script src="admin_resources/assets/js/vendor/visualization/d3/d3_tooltip.js"></script>
    {{-- /Sweet Alert --}}

    <!-- Theme JS files -->
    <script src="{{ asset('admin_resources/assets_layout/js/app.js') }}"></script>
    <script src="admin_resources/assets/demo/pages/dashboard.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/streamgraph.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/sparklines.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/lines.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/areas.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/donuts.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/bars.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/progress.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/heatmaps.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/pies.js"></script>
	<script src="admin_resources/assets/demo/charts/pages/dashboard/bullets.js"></script>
