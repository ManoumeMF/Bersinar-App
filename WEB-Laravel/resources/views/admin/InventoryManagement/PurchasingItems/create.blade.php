...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Tambah Pembelian Barang</h5>
        </div>
                ...
                <div class="col-lg-12">
                    <form action="#">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <select data-placeholder="Pilih No. Penimbangan Barang" class="form-control select">
                                        <option></option>
                                        <option value="1">Mudah Pecah</option>
                                        <option value="2">Organik</option>
                                        <option value="3">Anorganik</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input id="tanggal-pembelian" type="text"
                                                class="form-control datepicker-autohide3"
                                                placeholder="Pilih Tanggal Pembelian">
                                            <span class="input-group-text">
                                                <i class="ph-calendar"></i>
                                            </span>
                    ...
                    <div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mt-2 main-table" id="tblBarang">
