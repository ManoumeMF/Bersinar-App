...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex">
            ...
            <div class="ms-auto">
                <a class="btn btn-primary" href="{{ route('acceptitem.create') }}"><i class="ph-plus-circle"></i><span
        ...
        <table id="identityTable" class="table datatable-basic table-striped">
            ...
            <tbody>
                <tr>
                    <td>BSR/PNB/2023.10/00001</td>
                    <td>10 - 10 - 2023</td>
                    <td>NSJ/PNB/2023.10/00001</td>
                    <td>BSR/PNP/2023.10/00001</td>
                    <td>Nasabah - 1</td>
