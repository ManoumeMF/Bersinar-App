...
@section('content')
                    ...
                    '<tr>' 
                                        ...
                                        +'<td>'
                                            +'<div class="input-group">'
                                               +' <select data-placeholder="Jenis Nasabah" class="form-control select">'
                                                    +'<option></option>'
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Approval Pembelian Barang</h5>
        </div>
        <div class="card-body border-top">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <form action="#">
                        <div class="mb-3 row">
                            <label class="col-sm-2 col-form-label">No. Pembelian Barang:</label>
                            <div class="col-sm-3">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="text" class="form-control" value="BSR/PO/2023.10.09/00001" readonly>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <select data-placeholder="Cash" class="form-control select">
                                        <option></option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="text" class="form-control" value="BSR/PB/2023.10/00001" readonly>
                                </div>
                            </div>
                            <label for="tanggal_kirim" class="col-sm-2 offset-1 col-form-label">Mata Uang:</label>
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <select data-placeholder="Rupiah" class="form-control select">
                                        <option></option>
                                        <option value="1">Mudah Pecah</option>
                                        <option value="2">Organik</option>
                                        <option value="3">Anorganik</option>
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-6">
                                <div class="row mb-3">
                                    <label class="col-sm-4 col-form-label">Nasabah:</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" value="Jhoe Doe" readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="supplier" class="col-sm-4 col-form-label">Tanggal Dibuat PO:</label>
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                ...
                                <div class="row mb-3">
                                    <label for="supplier" class="col-sm-4 col-form-label">Tanggal kirim PO:</label>
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input id="tanggal-pembelian" type="text"
                                                class="form-control datepicker-autohide3" placeholder="23-03-2023">
                                            <span class="input-group-text">
                                                <i class="ph-calendar"></i>
                                            </span>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea rows="4" cols="50" class="form-control" placeholder="Oke"></textarea>
                                    </div>
                                </div>
                            </div>
