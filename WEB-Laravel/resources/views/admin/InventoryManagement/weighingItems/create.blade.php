    ...
    <div class="card">
        ...
        <div class="card-body border-top">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <form action="{{route('weighing.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input style="padding-top: 8px" type="text" class="form-control" 
                                    placeholder="Masukkan No. Penimbangan Barang" name="weighingNumCode" required>
                            </div>
                            <label for="tanggal_kirim" class="col-sm-2 offset-1 col-form-label">Tanggal Jemput
                                Barang:</label>
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input id="tanggal-jemput" name="dateWeighing" type="text" class="form-control datepicker-autohide"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <select data-placeholder="Pilih Nasabah" class="form-control select">
                                                <option></option>
                                                <option value="1">BSB/SJ/2023.10/00001</option>
                                                <option value="2">BSB/SJ/2023.10/00002</option>
                                                <option value="3">BSB/SJ/2023.10/00003</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input id="tanggal-penimbangan" type="text" class="form-control datepicker-autohide2"
