...
@section('content')
        ...
        $(document).ready(function() {
            ...
            $("#addBarang").on("click", function() {
                ...
                $("#tblBarang tbody").append(
                    ...
                    '<td>'+
                    ' <div class="row-sm-3">'+
                    '<input type="text" class="form-control" value="650000" readonly>'+
                    '</div>'+
                    '</td>'+
                    '<td>'+
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Approval Sales Order</h5>
        </div>
                ...
                <div class="col-lg-12">
                    <form action="#">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="text" class="form-control" value="Anna Lee" readonly>
                                </div>
                            </div>
