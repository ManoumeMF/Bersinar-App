...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Approval Serah Terima Penjualan Barang</h5>
        </div>
                ...
                <div class="col-lg-12">
                    <form action="#">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <select data-placeholder="BSB/SO/2023.10/00001" class="form-control select">
                                        <option></option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <select data-placeholder="Tom Cruise" class="form-control select">
                                        <option></option>
                                        <option value="1">Mudah Pecah</option>
                                        <option value="2">Organik</option>
                                        <option value="3">Anorganik</option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <select data-placeholder="Donni Yen" class="form-control select">
                                        <option></option>
                                        <option value="1">Mudah Pecah</option>
                                        <option value="2">Organik</option>
                                        <option value="3">Anorganik</option>
                        ...
                        <div class="mb-3 row">
                            <label for="keterangan" class="col-sm-3 col-form-label">Alasan Penolakan:</label>
                            <div class="col-sm-6">
                                <textarea rows="4" cols="100" class="form-control" placeholder="Masukkan Alasan Penolakan"></textarea>
                            </div>
                        </div>
                        <div>
