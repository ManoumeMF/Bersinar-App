...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Approval Pengiriman Barang</h5>
        </div>
                ...
                <div class="col-lg-12">
                    <form action="#">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <input type="text" class="form-control" value="BSB/PNB/2023.10/00001" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-3 col-form-label">Tanggal Kirim Barang:</label>
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <input id="tanggal-pembelian" type="text" class="form-control datepicker-autohide2"
                                        placeholder="20-03-2023">
                                    <span class="input-group-text">
                                        <i class="ph-calendar"></i>
                                    </span>
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-3 col-form-label">Jam Kirim Barang:</label>
                            <div class="col-sm-3">
                                <div class="input-group">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <select data-placeholder="BSB/PNB/2023.10/00001" class="form-control select">
                                        <option></option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <select data-placeholder="Will Smith" class="form-control select">
                                        <option></option>
                                        <option value="1">Mudah Pecah</option>
                                        <option value="2">Organik</option>
                                        <option value="3">Anorganik</option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <select data-placeholder="Pick Up" class="form-control select">
                                        <option></option>
                                        <option value="1">Mudah Pecah</option>
                                        <option value="2">Organik</option>
                                        <option value="3">Anorganik</option>
                        ...
                        <div class="mb-3 row">
                            <label for="keterangan" class="col-sm-3 col-form-label">Nomor Polisi:</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="D 354 ZY" readonly>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="keterangan" class="col-sm-3 col-form-label">Keperluan:</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="Pengiriman Barang ke Offtaker" readonly>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="keterangan" class="col-sm-3 col-form-label">Diterima Oleh:</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="D 354 Z" readonly>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="keterangan" class="col-sm-3 col-form-label">Alasan Ditolak:</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="Tidak memiliki SIM" readonly>
                            </div>
                        </div>
                        <div>
