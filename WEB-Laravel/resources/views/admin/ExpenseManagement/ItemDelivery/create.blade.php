...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Tambah Pengiriman Barang</h5>
        </div>
                ...
                <div class="col-lg-12">
                    <form action="#">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <select data-placeholder="Pilih No. Serah Terima Penjualan Barang"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="Masukkan No. Polisi Kendaraan"></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="keterangan" class="col-sm-3 col-form-label">Keperluan:</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="Masukkan Keperluan"></textarea>
                            </div>
                        </div>
                        <div>
