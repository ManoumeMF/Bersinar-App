...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex">
            <h5 class="mb-0">Daftar Pengiriman Barang</h5>
            <div class="ms-auto">
                <a class="btn btn-primary" href="{{ route('itemdelivery.create') }}"><i class="ph-plus-circle"></i><span
        ...
        <table id="identityTable" class="table datatable-basic table-striped">
            <thead>
                <tr>
                    <th>No. Surat Pengiriman Barang</th>
